            ...
            <Container className="h-[calc(100vh-4rem)] z-[5] w-full relative">
                <div className="lg:w-2/3 h-full text-center mx-auto flex flex-col items-center justify-center">
                    <div className="flex flex-col items-center">
                        <Image src={"/assets/img/adityaK.jpg"} height={250} width={250} className="object-contain mask mask-squircle h-[175px] w-[175px] md:h-[250px] md:w-[250px]" alt={""} />
                        <div className="flex-1 ">
                            <Balancer className="text-gray-600 dark:text-white font-cal text-xl text-center mt-[1rem] mb-[1rem] md:mt-0 w-full ">
                                Aditya Kumar
                            </Balancer>
                            <RotatingText />
